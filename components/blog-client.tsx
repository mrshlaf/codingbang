  ...
  return (
    <>
      ...
      <div className="flex flex-col flex-1 w-full max-w-4xl mx-auto px-6 py-24 md:py-32">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-foreground">Our Journal</h1>
          <p className="text-lg text-muted-foreground max-w-xl font-medium">
            We share insights, behind-the-scenes, and thoughts on web performance and modern engineering directly on Instagram.
          </p>
        </motion.div>
          ...
          <blockquote className="instagram-media mx-auto" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/DYfPR_jkwBQ/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style={{ background: "#FFF", border: "none", borderRadius: "24px", boxShadow: "0 10px 30px -10px rgba(0,0,0,0.15)", margin: "1px", maxWidth: "540px", minWidth: "326px", padding: 0, width: "calc(100% - 2px)" }}>
            <div style={{ padding: "16px" }}>
              ...
              <p style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", lineHeight: "17px", marginBottom: 0, marginTop: "8px", overflow: "hidden", padding: "8px 0 7px", textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                <a href="https://www.instagram.com/p/DYfPR_jkwBQ/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", fontStyle: "normal", fontWeight: "normal", lineHeight: "17px", textDecoration: "none" }} target="_blank" rel="noopener noreferrer">A post shared by CODING BANG | Media Technology (@codingbang)</a>
              </p>
            </div>
          </blockquote>
        </motion.div>
