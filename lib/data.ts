...
export const TEAM_MEMBERS: TeamMember[] = [
  { id: "1", name: "Marshal Aufa Diliyana", role: "Full-Stack Developer", bio: "Mengarsiteki arsitektur sistem dan memimpin pengembangan teknis setiap proyek.", skills: [], social: { github: "https://github.com/marshalauf", linkedin: "#", instagram: "#" }, display_order: 1 },
  ...
  { id: "5", name: "Tubagus Dafa Izza Fariz", role: "Full-Stack Developer", bio: "Merancang dan membangun pengalaman digital yang intuitif dan engaging.", skills: [], social: { github: "#", linkedin: "#", instagram: "#" }, display_order: 5 },
  { id: "6", name: "David Alexander", role: "Full-Stack Developer", bio: "Membangun dan mengoptimalkan sistem backend serta infrastruktur cloud.", skills: [], social: { github: "#", linkedin: "#", instagram: "#" }, display_order: 6 },
  { id: "7", name: "Nicholas Edmund Tanaka", role: "Full-Stack Developer", bio: "Mengembangkan komponen UI reusable dengan performa dan aksesibilitas tinggi.", skills: [], social: { github: "#", linkedin: "#", instagram: "#" }, display_order: 7 },
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    thumbnail_url: "",
    images: [],
    tech_stack: ["Next.js", "Tailwind CSS", "Supabase", "Recharts", "JWT"],
